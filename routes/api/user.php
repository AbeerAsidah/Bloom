...
Route::post('verify_otp',[PassportAuthController::class,'verifyOtp']);
...
//Report
    ...
    Route::prefix("reports")->group(function (){
        ...
        Route::get('/{project_id}/reports', [\App\Http\Controllers\ReportController::class, 'showReportsFor_user']);
